...
# Download GSE185344 dataset from GEO
# Load seurat object which was downloaded from GEO
seuratObj <- readRDS("data location/GSE185344_PH_scRNA.final.seuratobj.rds") 
# Load cell cluster data which was downloaded from GEO
group <- read.csv("location/GSE185344_PH_scRNA.rename_cluster.csv")

# Select a sample data
seuratObj <- subset(seuratObj,subset =orig.ident =="HYW_5755_Tumor")
...
seuratObj <- readRDS("HYW_5755_Tumor.RDS") 
